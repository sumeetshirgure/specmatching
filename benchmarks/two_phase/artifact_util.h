...
/// Shared scaffolding for the M3 and M6 exit artifacts.
///
/// The M1, M2 and M2.9 artifacts each carry their own copy of these helpers. They are landed,
/// frozen, and their recorded CSVs are the record of what they measured, so they are left alone —
/// but a fourth and fifth copy would be three too many, and the M3 and M6 artifacts genuinely share
/// a corpus generator and a CSV shape.

#ifndef PYREMATCHING_BENCHMARKS_TWO_PHASE_ARTIFACT_UTIL_H
#define PYREMATCHING_BENCHMARKS_TWO_PHASE_ARTIFACT_UTIL_H
...
#endif  // PYREMATCHING_BENCHMARKS_TWO_PHASE_ARTIFACT_UTIL_H
