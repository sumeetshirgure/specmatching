...
#ifndef PYREMATCHING_TWO_PHASE_CERTIFICATE_MAX_DUAL_H
#define PYREMATCHING_TWO_PHASE_CERTIFICATE_MAX_DUAL_H
...
#endif  // PYREMATCHING_TWO_PHASE_CERTIFICATE_MAX_DUAL_H
