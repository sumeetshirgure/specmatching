...
#ifndef PYREMATCHING_TWO_PHASE_TRUNCATION_EXPOSED_BLOSSOM_H
#define PYREMATCHING_TWO_PHASE_TRUNCATION_EXPOSED_BLOSSOM_H
...
#endif  // PYREMATCHING_TWO_PHASE_TRUNCATION_EXPOSED_BLOSSOM_H
