...
#ifndef PYREMATCHING_TWO_PHASE_MANIFOLD_BALL_SERIALIZE_H
#define PYREMATCHING_TWO_PHASE_MANIFOLD_BALL_SERIALIZE_H
...
#endif  // PYREMATCHING_TWO_PHASE_MANIFOLD_BALL_SERIALIZE_H
