...
#ifndef PYREMATCHING_SPEC_MATCHING_TRUNCATION_TRUNCATED_TIMELINE_H
#define PYREMATCHING_SPEC_MATCHING_TRUNCATION_TRUNCATED_TIMELINE_H
...
#endif  // PYREMATCHING_SPEC_MATCHING_TRUNCATION_TRUNCATED_TIMELINE_H
