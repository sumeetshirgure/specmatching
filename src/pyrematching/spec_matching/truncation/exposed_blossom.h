...
#ifndef PYREMATCHING_SPEC_MATCHING_TRUNCATION_EXPOSED_BLOSSOM_H
#define PYREMATCHING_SPEC_MATCHING_TRUNCATION_EXPOSED_BLOSSOM_H
...
#endif  // PYREMATCHING_SPEC_MATCHING_TRUNCATION_EXPOSED_BLOSSOM_H
