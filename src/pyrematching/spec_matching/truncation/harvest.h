...
#ifndef PYREMATCHING_SPEC_MATCHING_TRUNCATION_HARVEST_H
#define PYREMATCHING_SPEC_MATCHING_TRUNCATION_HARVEST_H
...
#include "pyrematching/spec_matching/truncation/horizon.h"
...
/// dumped whole trees into the residual would break the separation property the spec-matching design
/// rests on.
...
#endif  // PYREMATCHING_SPEC_MATCHING_TRUNCATION_HARVEST_H
