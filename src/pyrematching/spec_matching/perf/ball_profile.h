...
#ifndef PYREMATCHING_SPEC_MATCHING_PERF_BALL_PROFILE_H
#define PYREMATCHING_SPEC_MATCHING_PERF_BALL_PROFILE_H
...
/// Campaign-level accumulator, mirroring `SpecMatchingAggregateStats`. `speedup_vs_m1` is the headline
...
#endif  // PYREMATCHING_SPEC_MATCHING_PERF_BALL_PROFILE_H
