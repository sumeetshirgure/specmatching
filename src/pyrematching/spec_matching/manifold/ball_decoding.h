...
#ifndef PYREMATCHING_SPEC_MATCHING_MANIFOLD_BALL_DECODING_H
#define PYREMATCHING_SPEC_MATCHING_MANIFOLD_BALL_DECODING_H
...
#endif  // PYREMATCHING_SPEC_MATCHING_MANIFOLD_BALL_DECODING_H
