...
#ifndef PYREMATCHING_SPEC_MATCHING_MANIFOLD_BALL_GRAPH_H
#define PYREMATCHING_SPEC_MATCHING_MANIFOLD_BALL_GRAPH_H
...
#endif  // PYREMATCHING_SPEC_MATCHING_MANIFOLD_BALL_GRAPH_H
