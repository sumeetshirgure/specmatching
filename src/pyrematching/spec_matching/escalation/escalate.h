...
#ifndef PYREMATCHING_SPEC_MATCHING_ESCALATION_ESCALATE_H
#define PYREMATCHING_SPEC_MATCHING_ESCALATION_ESCALATE_H
...
bool escalate_to_stock_edges(
    pm::Mwpm& g_mwpm, const std::vector<uint64_t>& dets, std::vector<int64_t>& edges, SpecMatchingProfile* prof = nullptr);

}  // namespace spec_matching
}  // namespace pm

#endif  // PYREMATCHING_SPEC_MATCHING_ESCALATION_ESCALATE_H
