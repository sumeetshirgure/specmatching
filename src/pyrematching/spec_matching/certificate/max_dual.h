...
#ifndef PYREMATCHING_SPEC_MATCHING_CERTIFICATE_MAX_DUAL_H
#define PYREMATCHING_SPEC_MATCHING_CERTIFICATE_MAX_DUAL_H
...
#endif  // PYREMATCHING_SPEC_MATCHING_CERTIFICATE_MAX_DUAL_H
