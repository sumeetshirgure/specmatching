...
#ifndef PYREMATCHING_FILL_MATCH_ARENA_H
#define PYREMATCHING_FILL_MATCH_ARENA_H
...
/// Detects types that opt into arena liveness tracking (pyrematching §M2.9.1) by declaring
///
