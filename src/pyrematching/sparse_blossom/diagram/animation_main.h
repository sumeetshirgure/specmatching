...
#ifndef PYREMATCHING2_DIAGRAM_MAIN_H
#define PYREMATCHING2_DIAGRAM_MAIN_H
...
/// Here is an example of how to create an animation, assuming stim and pyrematching are installed:
///
