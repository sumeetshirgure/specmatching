...
#ifndef PYREMATCHING2_VARYING_H
#define PYREMATCHING2_VARYING_H
...
#include "pyrematching/sparse_blossom/flooder_matcher_interop/varying.inl"

}  // namespace pm

#endif  // PYREMATCHING2_VARYING_H
