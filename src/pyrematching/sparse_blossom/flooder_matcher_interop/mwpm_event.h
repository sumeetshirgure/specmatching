...
#ifndef PYREMATCHING_FILL_MATCH_MWPM_EVENT_H
#define PYREMATCHING_FILL_MATCH_MWPM_EVENT_H

#include "pyrematching/sparse_blossom/flooder_matcher_interop/compressed_edge.h"
...
#endif  // PYREMATCHING_FILL_MATCH_MWPM_EVENT_H
