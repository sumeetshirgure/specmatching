...
#ifndef PYREMATCHING2_SEARCH_GRAPH_H
#define PYREMATCHING2_SEARCH_GRAPH_H

#include <unordered_map>

#include "pyrematching/sparse_blossom/flooder/graph.h"
#include "pyrematching/sparse_blossom/search/search_detector_node.h"
...
#endif  // PYREMATCHING2_SEARCH_GRAPH_H
