...
#ifndef SPECMATCHING_SPEC_MATCHING_ESCALATION_ESCALATE_H
#define SPECMATCHING_SPEC_MATCHING_ESCALATION_ESCALATE_H
...
#endif  // SPECMATCHING_SPEC_MATCHING_ESCALATION_ESCALATE_H
