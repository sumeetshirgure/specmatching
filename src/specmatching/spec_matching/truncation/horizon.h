...
#ifndef SPECMATCHING_SPEC_MATCHING_TRUNCATION_HORIZON_H
#define SPECMATCHING_SPEC_MATCHING_TRUNCATION_HORIZON_H
...
#endif  // SPECMATCHING_SPEC_MATCHING_TRUNCATION_HORIZON_H
