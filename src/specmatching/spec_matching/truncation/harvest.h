...
#ifndef SPECMATCHING_SPEC_MATCHING_TRUNCATION_HARVEST_H
#define SPECMATCHING_SPEC_MATCHING_TRUNCATION_HARVEST_H
...
#endif  // SPECMATCHING_SPEC_MATCHING_TRUNCATION_HARVEST_H
