...
#ifndef SPECMATCHING_SPEC_MATCHING_TRUNCATION_TRUNCATED_TIMELINE_H
#define SPECMATCHING_SPEC_MATCHING_TRUNCATION_TRUNCATED_TIMELINE_H
...
#endif  // SPECMATCHING_SPEC_MATCHING_TRUNCATION_TRUNCATED_TIMELINE_H
