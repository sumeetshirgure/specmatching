...
#ifndef SPECMATCHING_SPEC_MATCHING_MANIFOLD_BALL_MWPM_H
#define SPECMATCHING_SPEC_MATCHING_MANIFOLD_BALL_MWPM_H
...
#endif  // SPECMATCHING_SPEC_MATCHING_MANIFOLD_BALL_MWPM_H
