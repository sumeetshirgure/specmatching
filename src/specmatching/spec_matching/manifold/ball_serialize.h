...
#ifndef SPECMATCHING_SPEC_MATCHING_MANIFOLD_BALL_SERIALIZE_H
#define SPECMATCHING_SPEC_MATCHING_MANIFOLD_BALL_SERIALIZE_H
...
#endif  // SPECMATCHING_SPEC_MATCHING_MANIFOLD_BALL_SERIALIZE_H
