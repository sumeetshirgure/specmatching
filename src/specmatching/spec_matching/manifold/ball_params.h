...
#ifndef SPECMATCHING_SPEC_MATCHING_MANIFOLD_BALL_PARAMS_H
#define SPECMATCHING_SPEC_MATCHING_MANIFOLD_BALL_PARAMS_H
...
#endif  // SPECMATCHING_SPEC_MATCHING_MANIFOLD_BALL_PARAMS_H
