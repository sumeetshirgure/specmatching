...
#ifndef SPECMATCHING_SPEC_MATCHING_PERF_BALL_PROFILE_H
#define SPECMATCHING_SPEC_MATCHING_PERF_BALL_PROFILE_H
...
#endif  // SPECMATCHING_SPEC_MATCHING_PERF_BALL_PROFILE_H
