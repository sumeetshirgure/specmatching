...
#ifndef SPECMATCHING2_GRAPH_FILL_REGION_H
#define SPECMATCHING2_GRAPH_FILL_REGION_H

#include <vector>

#include "specmatching/sparse_blossom/arena.h"
#include "specmatching/sparse_blossom/flooder/match.h"
...
#include "specmatching/sparse_blossom/tracker/queued_event_tracker.h"
...
struct GraphFillRegion {
    ...
    /// Slot in `Arena<GraphFillRegion>::live`, maintained by the arena (specmatching §M2.9.2).
...
#endif  // SPECMATCHING2_GRAPH_FILL_REGION_H
