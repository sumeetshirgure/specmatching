...
#ifndef SPECMATCHING_FILL_MATCH_QUEUED_EVENT_TRACKER_H
#define SPECMATCHING_FILL_MATCH_QUEUED_EVENT_TRACKER_H
...
#endif  // SPECMATCHING_FILL_MATCH_QUEUED_EVENT_TRACKER_H
