...
#ifndef SPECMATCHING2_MWPM_DECODING_H
#define SPECMATCHING2_MWPM_DECODING_H
...
///
/// Factored out of `decode_detection_events_to_edges` (specmatching M5) so that the spec-matching
...
#endif  // SPECMATCHING2_MWPM_DECODING_H
