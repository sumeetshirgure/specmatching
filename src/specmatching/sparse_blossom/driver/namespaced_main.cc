...
#include "specmatching/sparse_blossom/diagram/animation_main.h"
...
int pm::main(int argc, const char **argv) {
    ...
    ss << "    specmatching predict --dem file [--in file] [--out file] [--in_format 01|b8|...] [--out_format 01|b8|...] "
          "[--in_includes_appended_observables]\n";
    ss << "    specmatching count_mistakes --dem file [--in file] [--out file] [--in_format 01|b8|...] [--out_format "
          "01|B8|...] [--in_includes_appended_observables] [--obs_in] [--obs_in_format]\n";
    ss << "    specmatching animate "
          "--dets_in <file> "
