...
DecodingTestCase load_surface_code_d13_p100_test_case() {
    return load_test_case(
        ...
        "surface_code_rotated_memory_x_13_0.01_1000_shots_10000_buckets_solution_weights_specmatchingv0.7_exact.txt",
        "surface_code_rotated_memory_x_13_0.01_1000_shots_10000_buckets_predictions_specmatchingv0.7_exact.txt");
}
...
DecodingTestCase load_surface_code_d13_p100_some_negative_weights_test_case() {
    return load_test_case(
        ...
        "specmatchingv0.7_exact.txt",
        "surface_code_rotated_memory_x_13_0.01_prob_0.2_negative_1000_shots_10000_buckets_predictions_specmatchingv0.7_"
        "exact.txt");
}
