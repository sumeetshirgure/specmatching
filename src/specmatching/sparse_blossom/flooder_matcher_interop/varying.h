...
#ifndef SPECMATCHING2_VARYING_H
#define SPECMATCHING2_VARYING_H
...
#include "specmatching/sparse_blossom/flooder_matcher_interop/varying.inl"

}  // namespace pm

#endif  // SPECMATCHING2_VARYING_H
