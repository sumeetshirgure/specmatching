...
#ifndef SPECMATCHING2_ALTERNATING_TREE_H
#define SPECMATCHING2_ALTERNATING_TREE_H
...
class AltTreeNode {
   public:
    ...
    bool visited;
    /// Slot in `Arena<AltTreeNode>::live`, maintained by the arena (specmatching §M2.9.1).
...
#endif  // SPECMATCHING2_ALTERNATING_TREE_H
