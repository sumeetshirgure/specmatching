...
#ifndef SPECMATCHING2_DIAGRAM_MAIN_H
#define SPECMATCHING2_DIAGRAM_MAIN_H
...
/// Here is an example of how to create an animation, assuming stim and specmatching are installed:
///
